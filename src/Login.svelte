<script>
    ...
    const checkCredentials = () => {
      if (accounts[enteredEmail] === enteredPassword) {
        document.cookie = `loggedIn=true/email=${enteredEmail}/password=${enteredPassword}`;
  ...
  <main>
    ...
    <h1>Welcome to the Admin Control Panel for MesaCard</h1>
    <div class="screen-1">
      <svg class="logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="50" height="50" viewbox="0 0 0 0" xml:space="preserve">
      ...
      <div class="email">
        ...
        <div class="sec-2">
          ...
          <input bind:value={enteredEmail} type="email" name="email" placeholder="mail@example.com"/>
        </div>
      </div>
      <div class="password">
        ...
        <div class="sec-2">
          ...
          <input bind:value={enteredPassword} class="pas" type="password" name="password" placeholder="············"/>
        </div>
      </div>
